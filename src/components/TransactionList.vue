...
const paginatedTransactions = computed(() => {
  ...
  return filterTransactions.value.slice(startIndex, startIndex + perPage.value);
});
...
<template>
    ...
    <div class="form-group mb-0">
      ...
      <div class="form-check form-check-inline">
        <input
          ...
          v-model="filter"
        />
        <label for="filter-income" class="form-check-label cursor-pointer"
          >Income</label
        >
      </div>
      ...
      <div class="form-check form-check-inline">
        <input
          ...
          v-model="filter"
        />
        <label for="filter-expense" class="form-check-label cursor-pointer"
          >Expense</label
        >
      </div>
    </div>
  ...
  >
    ...
    <button
      :disabled="
        Number(currentPage) === Number(totalPages) || Number(totalPages) === 0
      "
      @click="nextPage"
      class="btn btn-secondary"
    >
